...
```{r}
#Initially tried gganimate, but couldn't get desired results. Instead used a long and annoying approach of generating each frame individually and creating a gif of them using the magick package.
...
for(i in 1:length(start)){
  ...
  frameName = paste0("frame_", as.character(n), ".png")
